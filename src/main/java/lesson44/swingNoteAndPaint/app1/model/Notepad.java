package lesson44.swingNoteAndPaint.app1.model;
...
public class Notepad {
	...
	try {
	    ...
	    String toSave = null;
	    toSave = noteType.getNoteType() + ":" + Calendar.getInstance().getTime() + ":" + s;
	    wr.println(toSave);
	    wr.flush();
	} finally {
	    wr.close();
    ...
    public List<String> read(NoteEnum noteType) throws FileNotFoundException, IOException {
