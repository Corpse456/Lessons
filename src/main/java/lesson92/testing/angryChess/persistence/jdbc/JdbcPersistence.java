package lesson92.testing.angryChess.persistence.jdbc;
...
import lesson92.testing.angryChess.persistence.IChessPersistenceAPI;
import lesson92.testing.angryChess.shared_model.IGame;
import lesson92.testing.angryChess.shared_model.IGameHistory;
...
public class JdbcPersistence implements IChessPersistenceAPI {
	...
	public List<IGameHistory> getGamesHistory() {
		// TODO Auto-generated method stub
		return new ArrayList<IGameHistory>();
	}
