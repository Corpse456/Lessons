package lesson63.css2_WebServer.src.edu.chess.simulator;
...
public class SimulatorGame extends Thread {
    ...
    public SimulatorGame () {
        ...
        try {
            socket.setSoTimeout(60000);// Таймаут ожидания клиета в открытом
                                       // сокете.
    ...
    public void run () {
        while (true) {
            ...
            try {
                // Оправляем в порт 1024 каждую минуту новую рандомную игру, и
                // даже пробуем
