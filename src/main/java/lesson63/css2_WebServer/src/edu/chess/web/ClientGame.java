package lesson63.css2_WebServer.src.edu.chess.web;
...
import lesson63.css2_WebServer.src.edu.chess.simulator.interfaces.IGame;
import lesson63.css2_WebServer.src.edu.chess.simulator.randomise.RandomGame;
import lesson63.css2_WebServer.src.edu.chess.web.page_crearors.PageCreator;
import lesson63.css2_WebServer.src.edu.chess.web.page_crearors.PageCreatorForHttpServer;
...
public class ClientGame extends Thread {
    ...
    private void createPageGame () {
        ...
        new PageCreatorForHttpServer(inputGame).createPages(); // - для
                                                               // http-server
    }

    /**
     * Принимает из потока, соеденённого с сервером рандомной игры, какую-то
     * игру.
     * 
     * @throws ClassNotFoundException
     *             - косяк при обратной серилизации, если не тот класс.
     * @throws IOException
     *             - косяк с потоком от сервера.
     */
