package lesson48.threads_streams.by.shipalex.day12;
...
public class MyThread extends Thread {
    ...
    public static void main2 (String[] args) {
        ...
        /*
         * join() не дает работать потоку main до окончания выполнения потока
         * tr1
         */
    }
    ...
    public static void main3 (String[] args) {
        ...
        }.start(); // неизестно успеет ли начаться второй поток в тот квант
                   // времени, на который
                   // остановится первый.
